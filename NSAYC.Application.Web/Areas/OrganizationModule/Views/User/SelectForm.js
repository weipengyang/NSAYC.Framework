...
var bootstrap = function ($, learun) {
    ...
    function renderSelectedUserlist() {
        ...
        if (!!selectValue)
        {
            NSAYC.httpAsync('GET', top.$.rootUrl + '/OrganizationModule/User/GetEntityListByUserIds', { keyValue: selectValue }, function (data) {
                if (!!data) {
        ...
        bind: function () {
            ...
            $('#department_tree').lrtree({
                nodeClick: function (item) {
                    ...
                    if (!!userlist[item.id]) {
                        ...
                        NSAYC.httpAsync('GET', top.$.rootUrl + '/OrganizationModule/User/GetList', { companyId: companyId, departmentId: departmentId }, function (data) {
            ...
            $("#txt_keyword").keydown(function (event) {
                if (event.keyCode == 13) {
                    ...
                    if (keyword != "") {
                        NSAYC.httpAsync('GET', top.$.rootUrl + '/OrganizationModule/User/GetList', { companyId: companyId, keyword: keyword }, function (data) {
                            renderUserlist(data || []);
                        });
                    }
                    else {
