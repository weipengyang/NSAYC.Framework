    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#lr_add').on('click', function () {
                ...
                NSAYC.layerForm({
                    id: 'form',
                    title: '添加账号',
                    url: top.$.rootUrl + '/OrganizationModule/User/Form?companyId=' + companyId,
                    width: 750,
                    height: 450,
            ...
            $('#lr_delete').on('click', function () {
                ...
                if (NSAYC.checkrow(keyValue)) {
                    NSAYC.layerConfirm('是否确认删除该项！', function (res) {
                        if (res) {
                            NSAYC.deleteForm(top.$.rootUrl + '/OrganizationModule/User/DeleteForm', { keyValue: keyValue }, function () {
                                refreshGirdData();
                            });
                        }
                    });
            ...
            $('#lr_export').on('click', function () {
                location.href = top.$.rootUrl + "/OrganizationModule/User/ExportUserList";
            });
            // 启用
            $('#lr_enabled').on('click', function () {
                var keyValue = $('#girdtable').jfGridValue('F_UserId');
                if (NSAYC.checkrow(keyValue)) {
                    NSAYC.layerConfirm('是否确认要【启用】账号！', function (res) {
                        if (res) {
                            NSAYC.postForm(top.$.rootUrl + '/OrganizationModule/User/UpdateState', { keyValue: keyValue, state: 1 }, function () {
                                refreshGirdData();
                            });
                        }
                    });
            ...
            $('#lr_disabled').on('click', function () {
                var keyValue = $('#girdtable').jfGridValue('F_UserId');
                if (NSAYC.checkrow(keyValue)) {
                    NSAYC.layerConfirm('是否确认要【禁用】账号！', function (res) {
                        if (res) {
                            NSAYC.postForm(top.$.rootUrl + '/OrganizationModule/User/UpdateState', { keyValue: keyValue, state: 0 }, function () {
                                refreshGirdData();
                            });
                        }
                    });
            ...
            $('#lr_resetpassword').on('click', function () {
                var keyValue = $('#girdtable').jfGridValue('F_UserId');
                if (NSAYC.checkrow(keyValue)) {
                    NSAYC.layerConfirm('是否确认要【重置密码】！', function (res) {
                        if (res) {
                            NSAYC.postForm(top.$.rootUrl + '/OrganizationModule/User/ResetPassword', { keyValue: keyValue}, function () {
                            });
                        }
                    });
                }
            ...
            $('#lr_dataauthorize').on('click', function () {
                ...
                if (NSAYC.checkrow(keyValue)) {
                    NSAYC.layerForm({
                        ...
                        url: top.$.rootUrl + '/AuthorizeModule/DataAuthorize/Index?objectId=' + keyValue + '&objectType=2',
                        width: 1100,
                        height: 700,
                        maxmin: true,
                        btn: null
            ...
            $('#lr_ipfilter').on('click', function () {
                ...
                if (NSAYC.checkrow(keyValue)) {
                    NSAYC.layerForm({
                        ...
                        url: top.$.rootUrl + '/AuthorizeModule/FilterIP/Index?objectId=' + keyValue + '&objectType=Uesr',
                        width: 600,
                        height: 400,
                        btn: null,
                        callBack: function (id) { }
            ...
            $('#lr_timefilter').on('click', function () {
                ...
                if (NSAYC.checkrow(keyValue)) {
                    NSAYC.layerForm({
                        ...
                        url: top.$.rootUrl + '/AuthorizeModule/FilterTime/Form?objectId=' + keyValue + '&objectType=Uesr',
                        width: 610,
                        height: 470,
                        callBack: function (id) {
        ...
        initGird: function () {
            $('#girdtable').lrAuthorizeJfGrid({
                url: top.$.rootUrl + '/OrganizationModule/User/GetPageList',
                headData: [
