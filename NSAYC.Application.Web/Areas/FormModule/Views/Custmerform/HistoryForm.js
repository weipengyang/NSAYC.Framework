...
var bootstrap = function ($, learun) {
    ...
    var page = {
                ...
                if (NSAYC.checkrow(schemeId)) {
                    if (schemeId != nowschemeId) {
                        NSAYC.layerConfirm('是否要更新到该版本！', function (res) {
                            if (res) {
                                NSAYC.postForm(top.$.rootUrl + '/FormModule/Custmerform/UpdateScheme', { schemeInfoId: keyValue, schemeId: schemeId }, function () {
        ...
        initGird: function () {
            $('#girdtable').jfGrid({
                url: top.$.rootUrl + '/FormModule/Custmerform/GetSchemePageList',
                headData: [
