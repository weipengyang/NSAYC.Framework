...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            NSAYC.httpAsync('GET', top.$.rootUrl + '/SystemModule/DatabaseTable/GetFieldList', { databaseLinkId: dbId, tableName: tableName }, function (data) {
            ...
            $('#dataSourceId').lrselect({
                ...
                select: function (item) {
                    ...
                    if (!!item) {
                        ...
                        NSAYC.httpAsync('GET', top.$.rootUrl + '/SystemModule/DataSource/GetDataColName', { code: item.F_Code }, function (data) {
            ...
            $('#lr_edit_datasource').on('click', function () {
                ...
                if (NSAYC.checkrow(_name)) {
                    NSAYC.layerForm({
                        id: 'SetSelectFieldForm',
                        title: '设置选择字段',
                        url: top.$.rootUrl + '/FormModule/Custmerform/SetSelectFieldForm?dbId=' + dbId + '&tableName=' + tableName,
                        width: 450,
                        height: 400,
    ...
    acceptClick = function (callBack) {
        ...
        var resdata = {};
        resdata.id = keyValue || NSAYC.newGuid();
