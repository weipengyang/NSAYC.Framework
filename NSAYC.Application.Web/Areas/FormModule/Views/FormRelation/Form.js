...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
                    ...
                    if (data.step == 1) {
                        ...
                        $.lrSetForm(top.$.rootUrl + '/FormModule/Custmerform/GetFormData?keyValue=' + formId, function (data) {//
                            ...
                            if (!!tableFields[formscheme.dbId + mainTable]) {
                                ...
                                NSAYC.httpAsync('GET', top.$.rootUrl + '/SystemModule/DatabaseTable/GetFieldList', { databaseLinkId: formscheme.dbId, tableName: mainTable }, function (data) {
            ...
            $('#lr_add_query').on('click', function () {
                NSAYC.layerForm({
                    id: 'QueryFieldForm',
                    title: '添加条件字段',
                    url: top.$.rootUrl + '/FormModule/FormRelation/QueryFieldForm',
                    height: 300,
                    width: 400,
            ...
            $('#lr_edit_query').on('click', function () {
                ...
                if (NSAYC.checkrow(id)) {
                    NSAYC.layerForm({
                        id: 'QueryFieldForm',
                        title: '添加条件字段',
                        url: top.$.rootUrl + '/FormModule/FormRelation/QueryFieldForm?id=' + id,
                        height: 300,
                        width: 400,
                        callBack: function (id) {
                            return top[id].acceptClick(function (data) {
            ...
            $('#lr_add_col').on('click', function () {
                NSAYC.layerForm({
                    id: 'ColFieldForm',
                    title: '添加列表字段',
                    url: top.$.rootUrl + '/FormModule/FormRelation/ColFieldForm',
                    height: 300,
                    width: 400,
                    callBack: function (id) {
                        return top[id].acceptClick(function (data) {
            ...
            $('#lr_edit_col').on('click', function () {
                ...
                if (NSAYC.checkrow(id)) {
                    NSAYC.layerForm({
                        id: 'ColFieldForm',
                        title: '添加条件字段',
                        url: top.$.rootUrl + '/FormModule/FormRelation/ColFieldForm?id=' + id,
                        height: 300,
                        width: 400,
                        callBack: function (id) {
                            return top[id].acceptClick(function (data) {
        ...
        initData: function () {
            if (!!keyValue) {
                $.lrSetForm(top.$.rootUrl + '/FormModule/FormRelation/GetFormData?keyValue=' + keyValue, function (data) {//
        ...
        save: function () {
            ...
            for (var i = 0, l = colData.length; i < l; i++) {
                ...
                var point = { F_ModuleColumnId: NSAYC.newGuid(), F_FullName: colData[i].fieldName, F_EnCode: code.toLowerCase() };
            ...
            $.lrSaveForm(top.$.rootUrl + '/FormModule/FormRelation/SaveForm?keyValue=' + keyValue, postData, function (res) {
                // 保存成功后才回调
