    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#lr_delete').on('click', function () {
                ...
                if (NSAYC.checkrow(keyValue)) {
                    NSAYC.layerConfirm('是否确认删除该项！', function (res) {
                        if (res) {
                            NSAYC.deleteForm(top.$.rootUrl + '/ReportModule/ReportManage/DeleteForm', { keyValue: keyValue }, function () {
                                refreshGirdData();
                            });
                        }
                    });
            ...
            $('#lr_preview').on('click', function () {
                var keyValue = $('#girdtable').jfGridValue('F_TempId');
                NSAYC.frameTab.open({ F_ModuleId: 'preview_' + keyValue, F_Icon: 'fa fa fa-eye', F_FullName: '预览报表', F_UrlAddress: '/ReportModule/ReportManage/Preview?reportId=' + keyValue + '&type=preview' });
            });
        },
        initGird: function () {
            $('#girdtable').jfGrid({
                url: top.$.rootUrl + '/ReportModule/ReportManage/GetPageList',
                headData: [
