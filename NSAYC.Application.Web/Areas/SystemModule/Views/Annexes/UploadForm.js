...
var bootstrap = function ($, learun) {
    ...
    $.lrSetForm(top.$.rootUrl + '/SystemModule/Annexes/GetAnnexesFileList?folderId=' + keyVaule, function (data) {
        for (var i = 0, l = data.length; i < l; i++) {
            ...
            $item.append('<span class="lr-file-name">' + item.F_FileName + '(' + NSAYC.countFileSize(item.F_FileSize) + ')</span>');
    ...
    var DeleteFile = function (fileId) {
        ...
        NSAYC.httpAsyncPost(top.$.rootUrl + "/SystemModule/Annexes/DeleteAnnexesFile", param, function (res) {});
    ...
    var DownFile = function (fileId) {
        NSAYC.download({ url: top.$.rootUrl + '/SystemModule/Annexes/DownAnnexesFile', param: { fileId: fileId, __RequestVerificationToken: $.lrToken }, method: 'POST' });
    }
