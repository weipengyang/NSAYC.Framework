    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#lr_add').on('click', function () {
                ...
                NSAYC.layerForm({
                    id: 'Form',
                    title: '添加公共自定义查询',
                    url: top.$.rootUrl + '/SystemModule/CustmerQuery/Form',
                    width: 700,
                    height: 400,
            ...
            $('#lr_delete').on('click', function () {
                ...
                if (NSAYC.checkrow(keyValue)) {
                    NSAYC.layerConfirm('是否确认删除该项！', function (res) {
                        if (res) {
                            NSAYC.deleteForm(top.$.rootUrl + '/SystemModule/CustmerQuery/DeleteForm', { keyValue: keyValue }, function () {
                                refreshGirdData();
                            });
                        }
                    });
        ...
        initGird: function () {
            $('#girdtable').lrAuthorizeJfGrid({
                url: top.$.rootUrl + '/SystemModule/CustmerQuery/GetPageList',
                headData: [
