...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#lr_add').on('click', function () {
                ...
                NSAYC.layerForm({
                    id: 'form',
                    title: '添加区域',
                    url: top.$.rootUrl + '/SystemModule/Area/Form?parentId=' + parentId,
                    height: 310,
                    width: 500,
            ...
            $('#lr_delete').on('click', function () {
                ...
                if (NSAYC.checkrow(keyValue)) {
                    NSAYC.layerConfirm('是否确认删除该项！', function (res) {
                        if (res) {
                            NSAYC.deleteForm(top.$.rootUrl + '/SystemModule/Area/DeleteForm', { keyValue: keyValue }, function () {
                                refreshGird();
                            });
                        }
                    });
        ...
        initTree: function () {
            $('#lr_left_tree').lrtree({
                url: top.$.rootUrl + '/SystemModule/Area/GetTree',
