...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#querylist').on('click', function (e) {
                ...
                if ($et.hasClass('btn-edit')) {
                    ...
                    NSAYC.layerForm({
                        id: 'QueryForm',
                        title: '添加自定义查询条件',
                        url: top.$.rootUrl + '/AuthorizeModule/DataAuthorize/QueryForm?interfaceId=' + interfaceId + '&rowid=' + _rowid,
                        width: 500,
                        height: 300,
            ...
            $('#lr_query_add').on('click', function () {
                NSAYC.layerForm({
                    id: 'QueryForm',
                    title: '添加自定义查询条件',
                    url: top.$.rootUrl + '/AuthorizeModule/DataAuthorize/QueryForm?interfaceId=' + interfaceId,
                    width: 500,
                    height: 300,
                    callBack: function (id) {
                        return top[id].acceptClick(refreshData);
        ...
        initData: function () {
            if (!!keyValue) {
                $.lrSetForm(top.$.rootUrl + '/AuthorizeModule/DataAuthorize/GetDataAuthorizeEntity?keyValue=' + keyValue, function (data) {
    ...
    acceptClick = function (callBack) {
        ...
        $.lrSaveForm(top.$.rootUrl + '/AuthorizeModule/DataAuthorize/SaveForm?keyValue=' + keyValue, postData, function (res) {
            // 保存成功后才回调
            if (!!callBack) {
                callBack();
            }
