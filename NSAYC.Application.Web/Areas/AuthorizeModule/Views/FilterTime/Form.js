...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        initData: function () {
            $.lrSetForm(top.$.rootUrl + '/AuthorizeModule/FilterTime/GetFormData?keyValue=' + objectId, function (data) {
                var formdata = data || {};
    ...
    acceptClick = function () {
        ...
        $.lrSaveForm(top.$.rootUrl + '/AuthorizeModule/FilterTime/SaveForm', postData, function (res) { });
