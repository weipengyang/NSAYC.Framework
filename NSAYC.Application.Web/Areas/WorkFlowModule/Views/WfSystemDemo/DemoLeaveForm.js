...
var bootstrap = function ($, learun) {
    ...
    setFormData = function (processId) {
        if (!!processId) {
            $.lrSetForm(top.$.rootUrl + '/WorkFlowModule/WfSystemDemo/DemoLeaveGetFormData?processId=' + processId, function (data) {//
                if (!!data) {
                    isUpdate = true;
    ...
    save = function (processId, callBack, i) {
        ...
        $.lrSaveForm(top.$.rootUrl + '/WorkFlowModule/WfSystemDemo/DemoLeaveSaveForm?keyValue=' + keyValue, postData, function (res) {
            // 保存成功后才回调
            if (!!callBack) {
