...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        initData: function () {
            if (!!shcemeCode) {
                $.lrSetForm(top.$.rootUrl + '/WorkFlowModule/WfScheme/GetFormData?schemeCode=' + shcemeCode, function (data) {//
        ...
        draftsave: function () {
            ...
            $.lrSaveForm(top.$.rootUrl + '/WorkFlowModule/WfScheme/SaveForm?keyValue=' + keyValue, postData, function (res) {
                // 保存成功后才回调
                NSAYC.frameTab.currentIframe().refreshGirdData(formdata);
            });
        },
        /*保存数据*/
        save: function () {
