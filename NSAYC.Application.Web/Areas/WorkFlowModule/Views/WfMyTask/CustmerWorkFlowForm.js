    ...
    var flow = {
        release: function (isNew) { // 发起流程方法
            ...
            NSAYC.layerForm({
                id: 'ReleaseFlowForm',
                title: '发起流程',
                url: top.$.rootUrl + '/WorkFlowModule/WfMyTask/ReleaseFlowForm',
                width: 600,
                height: 400,
                                    ...
                                    NSAYC.workflowapi.create({
                                        ...
                                        callback: function (res, data) {
                                            if (res) {
                                                ...
                                                NSAYC.frameTab.close(tabIframeId);
                                            }                                            
                                        }
                                    });
                                }
                                else {
                                    NSAYC.alert.error('表单数据保存失败');
                                }
                            }
                            else {
                                setTimeout(function () {
        ...
        audit: function () { // 审核流程
            ...
            NSAYC.layerForm({
                id: 'AuditFlowForm',
                title: '审核流程',
                url: top.$.rootUrl + '/WorkFlowModule/WfMyTask/AuditFlowForm',
                width: 600,
                height: 400,
                callBack: function (id) {
                    return top[id].acceptClick(function (formData, auditers) {
        ...
        sign: function () { // 加签流程
            NSAYC.layerForm({
                id: 'AuditFlowForm',
                title: '加签审核',
                url: top.$.rootUrl + '/WorkFlowModule/WfMyTask/SignFlowForm',
                width: 600,
                height: 400,
                callBack: function (id) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#print').on('click', function () {
                ...
                var $iframe = NSAYC.iframe(iframeId, frames);
        ...
        iframeLoad: function (iframeId, url, callback, i) {
            ...
            var _iframeLoaded = function () {
                var iframeObj = NSAYC.iframe(iframeId, frames);
