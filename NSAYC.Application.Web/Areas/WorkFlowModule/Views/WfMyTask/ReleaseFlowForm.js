...
var bootstrap = function ($, learun) {
    "use strict";
    var type = NSAYC.frameTab.currentIframe().type;
    var shcemeCode = NSAYC.frameTab.currentIframe().shcemeCode;
    var processId = NSAYC.frameTab.currentIframe().processId;
    var taskId = NSAYC.frameTab.currentIframe().taskId;
    var formData = NSAYC.frameTab.currentIframe().allFormDatas;
