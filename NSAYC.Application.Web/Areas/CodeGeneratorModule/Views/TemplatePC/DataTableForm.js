                ...
                select: function (item) {
                    if (!!item) {
                        ...
                        if (!!fieldData) {
                            ...
                            NSAYC.httpAsync('GET', top.$.rootUrl + '/SystemModule/DatabaseTable/GetFieldList', { databaseLinkId: dbId, tableName: item.name }, function (data) {
