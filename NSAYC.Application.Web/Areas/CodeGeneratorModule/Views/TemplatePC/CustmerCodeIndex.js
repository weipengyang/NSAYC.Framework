...
var bootstrap = function ($, learun) {
    ...
    var page = {
            ...
            $('#wizard').wizard().on('change', function (e, data) {
                ...
                if (data.direction == "next") {
                    if (data.step == 1) {
                        ...
                        NSAYC.httpAsyncPost(top.$.rootUrl + '/CodeGeneratorModule/TemplatePC/LookCustmerCode', postData, function (res) {
                            if (res.code == 200) {
        ...
        save: function () {
            ...
            $.lrSaveForm(top.$.rootUrl + '/CodeGeneratorModule/TemplatePC/CreateCustmerCode', postData, function (res) { }, true);
        }
    };
