...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#lr_add').on('click', function () {
                NSAYC.layerForm({
                    id: 'form',
                    title: '添加公告',
                    url: top.$.rootUrl + '/OAModule/Notice/Form',
                    width: 1000,
                    height: 650,
                    maxmin: true,
            ...
            $('#lr_delete').on('click', function () {
                ...
                if (NSAYC.checkrow(keyValue)) {
                    NSAYC.layerConfirm('是否确认删除该项！', function (res) {
                        if (res) {
                            NSAYC.deleteForm(top.$.rootUrl + '/OAModule/Notice/DeleteForm', { keyValue: keyValue }, function () {
                                refreshGirdData();
                            });
                        }
                    });
        ...
        initGird: function () {
            $('#girdtable').jfGrid({
                url: top.$.rootUrl + '/OAModule/Notice/GetPageList',
                headData: [
