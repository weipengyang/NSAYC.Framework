...
using NSAYC.Application.BaseModule.CodeGeneratorModule;
using NSAYC.Util;
using System;
...
namespace NSAYC.Application.Base.CodeGeneratorModule
{
    /// <summary>
    ...
    public class CodeGenerator
    {
        ...
        private string NotesCreate(CodeBaseConfigModel baseConfigModel) {
            ...
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 NSAYCFrameWork V1.1.0 爱养车开发框架\r\n");
            sb.Append("    /// Copyright (c) 2013-2017 广州市爱养车汽车服务有限公司\r\n");
        ...
        public string MappingCreate(CodeBaseConfigModel baseConfigModel, string tableName)
        {
            try
            {
                ...
                sb.Append("namespace  NSAYC.Application.Mapping\r\n");
                sb.Append("{\r\n");
                sb.Append(NotesCreate(baseConfigModel));
        ...
        public string ServiceCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("using NSAYC.DataBase.Repository;\r\n");
                sb.Append("using NSAYC.Util;\r\n");
                sb.Append("using System;\r\n");
        ...
        public string ControllerCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("namespace NSAYC.Application.Web.Areas." + baseConfigModel.area + ".Controllers\r\n");
                sb.Append("{\r\n");
                sb.Append(NotesCreate(baseConfigModel));
        ...
        public string ControllerCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, Dictionary<string, CompontModel> compontMap, ColModel colData)
        {
            try
            {
                ...
                sb.Append("namespace NSAYC.Application.Web.Areas." + baseInfo.outputArea + ".Controllers\r\n");
                sb.Append("{\r\n");
                sb.Append(NotesCreate(baseInfo));
        ...
        public string IndexJSCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("/*");
                sb.Append(" * 版 本 NSAYCFrameWork V1.1.0 爱养车开发框架(http://www.NSAYC.cn)\r\n");
                sb.Append(" * Copyright (c) 2013-2017 广州市爱养车汽车服务有限公司\r\n");
                ...
                sb.Append("                if (NSAYC.checkrow(keyValue)) {\r\n");
                sb.Append("                    NSAYC.layerForm({\r\n");
                sb.Append("                        id: 'form',\r\n");
                sb.Append("                        title: '编辑',\r\n");
                ...
                sb.Append("                var keyValue = $('#girdtable').jfGridValue('" + pk + "');\r\n");
                sb.Append("                if (NSAYC.checkrow(keyValue)) {\r\n");
                sb.Append("                    NSAYC.layerConfirm('是否确认删除该项！', function (res) {\r\n");
                sb.Append("                        if (res) {\r\n");
                sb.Append("                            NSAYC.deleteForm(top.$.rootUrl + '/" + baseConfigModel.area + "/" + baseConfigModel.name + "/DeleteForm', { keyValue: keyValue}, function () {\r\n");
                sb.Append("                            });\r\n");
                sb.Append("                        }\r\n");
                sb.Append("                    });\r\n");
                sb.Append("                }\r\n");
        ...
        public string IndexJSCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, FormModel formData, Dictionary<string, CompontModel> compontMap, ColModel colData, QueryModel queryData)
        {
            try
            {
                ...
                if (queryData.isDate == "1")
                {
                    ...
                    sb.Append("                dfdata: [\r\n");
                    sb.Append("                    { name: '今天', begin: function () { return NSAYC.getDate('yyyy-MM-dd 00:00:00') }, end: function () { return NSAYC.getDate('yyyy-MM-dd 23:59:59') } },\r\n");
                    sb.Append("                    { name: '近7天', begin: function () { return NSAYC.getDate('yyyy-MM-dd 00:00:00', 'd', -6) }, end: function () { return NSAYC.getDate('yyyy-MM-dd 23:59:59') } },\r\n");
                    sb.Append("                    { name: '近1个月', begin: function () { return NSAYC.getDate('yyyy-MM-dd 00:00:00', 'm', -1) }, end: function () { return NSAYC.getDate('yyyy-MM-dd 23:59:59') } },\r\n");
                    sb.Append("                    { name: '近3个月', begin: function () { return NSAYC.getDate('yyyy-MM-dd 00:00:00', 'm', -3) }, end: function () { return NSAYC.getDate('yyyy-MM-dd 23:59:59') } }\r\n");
                    sb.Append("                ],\r\n");
                    sb.Append("                // 月\r\n");
                ...
                sb.Append("                    NSAYC.layerConfirm('是否确认删除该项！', function (res) {\r\n");
                sb.Append("                        if (res) {\r\n");
                sb.Append("                            NSAYC.deleteForm(top.$.rootUrl + '/" + baseInfo.outputArea + "/" + baseInfo.name + "/DeleteForm', { keyValue: keyValue}, function () {\r\n");
                ...
                foreach (var col in colData.fields)
                {
                    ...
                    if (compont.type == "select" || compont.type == "radio" || compont.type == "checkbox")
                    {
                        ...
                        if (compont.dataSource == "0")
                        {
                            sb.Append("                             NSAYC.clientdata.getAsync('dataItem', {\r\n");
                            sb.Append("                                 key: value,\r\n");
                        ...
                        {
                            string[] vlist = compont.dataSourceId.Split(',');
                            sb.Append("                             NSAYC.clientdata.getAsync('custmerData', {\r\n");
        ...
        public string WfIndexJSCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, FormModel formData, Dictionary<string, CompontModel> compontMap, ColModel colData, QueryModel queryData)
        {
            try
            {
                ...
                sb.Append("                        // 保存数据\r\n");
                sb.Append("                        if (res) {\r\n");
                sb.Append("                            processId = NSAYC.newGuid();\r\n");
                ...
                sb.Append("        {\r\n");
                sb.Append("            // 发起流程\r\n");
                sb.Append("            NSAYC.workflowapi.create({\r\n");
        ...
        public string FormJsCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("var bootstrap = function ($, learun) {\r\n");
                sb.Append("    \"use strict\";\r\n");
                sb.Append("    var selectedRow = NSAYC.frameTab.currentIframe().selectedRow;\r\n");
                sb.Append("    var page = {\r\n");
                sb.Append("        init: function () {\r\n");
                sb.Append("        },\r\n");
                sb.Append("        bind: function () {\r\n");
        ...
        public void CreateMapCodeFile(CodeBaseConfigModel codeBaseConfigModel, string tableName, string codeContent)
        {
            try
            {
                ...
                CreateCodeFile(codeBaseConfigModel.mappingDirectory + "\\" + backArea + tableName + "Map.cs", codeContent, codeBaseConfigModel.mappingDirectory + "\\NSAYC.Application.Mapping.csproj", backArea + tableName + "Map.cs", false);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateMapCodeFile(BaseModel baseInfo, string tableName, string codeContent)
        {
            ...
            {
                string backProject = ConfigurationManager.AppSettings["BackProject"].ToString();
                CreateCodeFile(baseInfo.mappingDirectory + "\\" + baseInfo.outputArea + "\\" + tableName + "Map.cs", codeContent, baseInfo.mappingDirectory + "\\NSAYC.Application.Mapping.csproj", baseInfo.outputArea + "\\" + tableName + "Map.cs", false);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateControllerCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Controllers\\" + codeBaseConfigModel.name + "Controller.cs", codeContent, codeBaseConfigModel.webDirectory + "\\NSAYC.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Controllers\\" + codeBaseConfigModel.name + "Controller.cs", false);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateControllerCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Controllers\\" + baseInfo.name + "Controller.cs", codeContent, baseInfo.webDirectory + "\\NSAYC.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Controllers\\" + baseInfo.name + "Controller.cs", false);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateIndexCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Index.cshtml", codeContent, codeBaseConfigModel.webDirectory + "\\NSAYC.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Index.cshtml", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateIndexCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Index.cshtml", codeContent, baseInfo.webDirectory + "\\NSAYC.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Index.cshtml", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateIndexJSCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Index.js", codeContent, codeBaseConfigModel.webDirectory + "\\NSAYC.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Index.js", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateIndexJSCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Index.js", codeContent, baseInfo.webDirectory + "\\NSAYC.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Index.js", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateFormCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Form.cshtml", codeContent, codeBaseConfigModel.webDirectory + "\\NSAYC.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Form.cshtml", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateFormCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Form.cshtml", codeContent, baseInfo.webDirectory + "\\NSAYC.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Form.cshtml", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateFormJSCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Form.js", codeContent, codeBaseConfigModel.webDirectory + "\\NSAYC.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Form.js", true);
            }
            catch (Exception)
            {
                throw;
        ...
        public void CreateFormJSCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Form.js", codeContent, baseInfo.webDirectory + "\\NSAYC.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Form.js", true);
            }
            catch (Exception)
            {
                throw;
