...
namespace NSAYC.DataBase.Oracle
{
    /// <summary>
    ...
    public class DatabaseContext : DbContext, IDisposable, IObjectContextAdapter
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            string assembleFileName = Assembly.GetExecutingAssembly().CodeBase.Replace("NSAYC.DataBase.Oracle.DLL", "NSAYC.Application.Mapping.DLL").Replace("file:///", "");
